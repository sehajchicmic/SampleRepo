...
public class BingoCardsLoader : MonoBehaviour
{
    ...
    public void LoadPrefab()
    {
        ...
        if (cards1.isOn)
        {
            ...
            temp.GetComponent<CardReference>().cardNumber1.text = "Card 1";
            temp.GetComponent<CardReference>().cardNumber2.text = "Card 2";
        ...
        else if (cards2.isOn)
        {
            ...
            temp1.GetComponent<CardReference>().cardNumber1.text = "Card 3";
            temp1.GetComponent<CardReference>().cardNumber2.text = "Card 4";
            disablebutton56.SetActive(false);
            disablebutton78.SetActive(false);
            scv.card2 = 2;
        ...
        else if(cards3.isOn)
        {
            ...
            temp2.GetComponent<CardReference>().cardNumber1.text = "Card 5";
